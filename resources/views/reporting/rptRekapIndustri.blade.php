...
<div class="card card-success">
  ...
  <form class="form-horizontal" action="{{ route('rptRekapIndustri.rpt') }}" method="POST">
     @csrf        
    <div class="card-body">          
      <div class="row">
        <div class="col-sm-3">
          <div class="form-group">
            <label>Nama Industri</label>
              <select class="form-control select2" name="lokIndustri" id="lokIndustri" style="width: 100%;">
                <option value="" selected="selected">-- Industri --</option>
                @foreach ($lokIndustri as $lokInds)
                  <option value="{{ $lokInds->kode_lokasi }}">{{ $lokInds->nama_lokasi }}</option>
                @endforeach
              </select>
          </div>
        </div>
...
<div class="card">
  ...
  <div class="card-body" style="height:500px;overflow:auto;">
    ...
    @endphp
    <h4 style="text-align:center;">REKAP INDUSTRI</h4>
    ...
    <h6 style="text-align:center;">LOKASI : {{ session('namaIndustri') }}</h6>
    <br>
