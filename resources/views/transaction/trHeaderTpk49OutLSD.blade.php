...
<!-- Content Header (Page header) -->
    ...
    <div class="card card-success">
      ...
      <form class="form-horizontal" action="{{ route('trHeaderTpk49OutLSD.add') }}" method="POST">
         @csrf        
        <div class="card-body">          
          <div class="row">
            <div class="col-sm-3">
              <div class="form-group">
                <label>No TPK</label>
                  <input type="text" class="form-control" id="no_tpn_out" name="no_tpn_out" placeholder="" value="TPK/600/{{ App\Http\Controllers\UserController::getNewNoTpkOut('600'); }}-OUT">
              </div>
            </div>
            <div class="col-sm-2">
              <div class="form-group">
            ...
            <div class="col-sm-2">
              <div class="form-group">
                <label>Lokasi</label>                
                  <input type="text" class="form-control" name="" value="TPK 49" disabled>
                  <input type="hidden" name="lokasi_tpn" id="lokasi_tpn" value="600">                
              </div>
            </div>
            <div class="col-sm-2">
              <div class="form-group">
                <label>Tujuan</label>                
                  <input type="text" class="form-control" name="" value="LP Sangai Drt" disabled>
                  <input type="hidden" name="tujuan" id="tujuan" value="710">                
              </div>
            </div>
    ...
    <div class="card">
      <!-- /.card-header -->
      <div class="card-body">
        <table id="trHeader49OutLSD" class="table table-bordered table-striped">
          <thead>
          <tr>
            <th>No TPN Out</th>
            <th>Tanggal</th>
    ...
    <div class="modal fade" id="modal-delete" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('trHeaderTpk49OutLSDDestroy.del') }}" method="post">
                  {{ csrf_field() }}
