...
@section('content')
    ...
    <div class="card card-success">
      ...
      <form class="form-horizontal" action="{{ route('trDetailSangaiDrtOutSangaiAir.add') }}" method="POST">
         @csrf
    ...
    <div class="modal fade" id="modal-delete" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('trDetailSangaiDrtOutSangaiAir.del') }}" method="post">
                  {{ csrf_field() }}
