...
<!-- Content Header (Page header) -->
    ...
    <div class="card card-success">
      ...
      <form class="form-horizontal" action="{{ route('trHeaderTpkAquaOutLSD.add') }}" method="POST">
         @csrf        
        <div class="card-body">          
          <div class="row">
            <div class="col-sm-3">
    ...
    <div class="card">
      <!-- /.card-header -->
      <div class="card-body">
        <table id="trHeaderAquaOutLSD" class="table table-bordered table-striped">
          <thead>
          <tr>
            <th>No TPN Out</th>
            <th>Tanggal</th>
    ...
    <div class="modal fade" id="modal-delete" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('trHeaderTpkAquaOutLSDDestroy.del') }}" method="post">
                  {{ csrf_field() }}
