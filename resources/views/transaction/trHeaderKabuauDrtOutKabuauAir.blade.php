...
@section('content')
    ...
    <div class="card card-success">
      ...
      <form class="form-horizontal" action="{{ route('trHeaderKabuauDrtOutKabuauAir.add') }}" method="POST">
         @csrf        
        <div class="card-body">          
          <div class="row">
            <div class="col-sm-3">
              <div class="form-group">
                <label>No LKD</label>
                  <input type="text" class="form-control" id="no_tpn_out" name="no_tpn_out" placeholder="" value="LKD/730/{{ App\Http\Controllers\UserController::getNewNoTpkOut('730'); }}-OUT">
              </div>
            </div>
            <div class="col-sm-2">
              <div class="form-group">
            ...
            <div class="col-sm-2">
              <div class="form-group">
                <label>Lokasi</label>                
                  <input type="text" class="form-control" name="" value="LP Kabuau Drt" disabled>
            ...
            <div class="col-sm-2">
              <div class="form-group">
                <label>Tujuan</label>                
                  ...
                  <input type="hidden" name="tujuan" id="tujuan" value="731">                
              </div>
            </div>
    ...
    <div class="card">
      <!-- /.card-header -->
      <div class="card-body">
        <table id="trHeaderKabuauDrtOutKabuauAir" class="table table-bordered table-striped">
          <thead>
          <tr>
            <th>No LSD Out</th>
            <th>Tanggal</th>
    ...
    <div class="modal fade" id="modal-delete" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('trHeaderKabuauDrtOutKabuauAirDestroy.del') }}" method="post">
                  {{ csrf_field() }}
