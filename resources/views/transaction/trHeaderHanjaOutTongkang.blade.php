...
<!-- Content Header (Page header) -->
    ...
    <div class="card card-success">
      ...
      <form class="form-horizontal" action="{{ route('trHeaderHanjaOutTongkang.add') }}" method="POST">
         @csrf        
        <div class="card-body">          
          <div class="row">
            <div class="col-sm-3">
              <div class="form-group">
                <label>No LHJ</label>
                  <input type="text" class="form-control" id="no_tpn_out" name="no_tpn_out" placeholder="" value="LHJ/740/{{ App\Http\Controllers\UserController::getNewNoTpkOut('740'); }}-OUT">
              </div>
            </div>
            <div class="col-sm-2">
              <div class="form-group">
            ...
            <div class="col-sm-2">
              <div class="form-group">
                <label>Lokasi</label>                
                  ...
                  <input type="hidden" name="lokasi_tpn" id="lokasi_tpn" value="740">                
              </div>
            </div>
            <div class="col-sm-2">
              <div class="form-group">
    ...
    <div class="card">
      <!-- /.card-header -->
      <div class="card-body">
        <table id="trHeaderHanjaOutTongkang" class="table table-bordered table-striped">
          <thead>
          <tr>
            <th>No LHJ Out</th>
            <th>Tanggal</th>
    ...
    <div class="modal fade" id="modal-delete" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('trHeaderHanjaOutTongkangDestroy.del') }}" method="post">
                  {{ csrf_field() }}
